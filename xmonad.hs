...
myKeys = M.fromList $
        ...
        , ((0, xK_F12), terminalScratchpadKey)
          -----------------------------------------------------------
          -- Program hotkeys
          -----------------------------------------------------------
        ...
        , ((myModMask, xK_Down), spawn "amixer set Master 1-")
          ...
          -- folder hotkeys
          -----------------------------------------------------------
        , ((controlMask .|. shiftMask, xK_r), spawn "thunar /")
        , ((controlMask .|. shiftMask, xK_d), spawn "thunar /media/media/bt")
        , ((controlMask .|. shiftMask, xK_a), spawn "thunar /media/media/Anime")
        , ((controlMask .|. shiftMask, xK_z), spawn "thunar /media/media/Music")
        , ((controlMask .|. shiftMask, xK_x), spawn "thunar /media/media/Movies")
        , ((controlMask .|. shiftMask, xK_s), spawn "thunar /media/media/tvshows")
        , ((controlMask .|. shiftMask, xK_c), spawn "thunar /media/documents/documents")
        , ((controlMask .|. shiftMask, xK_e), spawn "thunar /media/documents/documents/ebooks")
          -----------------------------------------------------------
        ...
        where 
            terminalScratchpadKey = scratchpadSpawnActionCustom 
                                    "gnome-terminal --disable-factory --name scratchpad"
